// Blackjack
// Plays a simple version of the cosino game of blackjack; 1 - 7 players
...
{
	cout << endl;
	//continure to deal a card as long as generic player isn't busted and
	//wants another hit
